 ...
 *******************************************************************************/
LIBLTE_ERROR_ENUM liblte_m2ap_pack_protocolie_singlecontainer(
...
LIBLTE_ERROR_ENUM liblte_m2ap_unpack_protocolie_singlecontainer(
  uint8_t                                                           **ptr,
  LIBLTE_M2AP_PROTOCOLIE_SINGLECONTAINER_STRUCT                      *ie)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
 ...
 *******************************************************************************/
LIBLTE_ERROR_ENUM liblte_m2ap_pack_protocolextensionid(
...
LIBLTE_ERROR_ENUM liblte_m2ap_unpack_protocolextensionid(
  uint8_t                                                           **ptr,
  LIBLTE_M2AP_PROTOCOLEXTENSIONID_STRUCT                             *ie)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
 ...
 *******************************************************************************/
LIBLTE_ERROR_ENUM liblte_m2ap_pack_criticalitydiagnostics(
...
LIBLTE_ERROR_ENUM liblte_m2ap_unpack_criticalitydiagnostics(
  uint8_t                                                           **ptr,
  LIBLTE_M2AP_CRITICALITYDIAGNOSTICS_STRUCT                      *ie)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
...
LIBLTE_ERROR_ENUM liblte_m2ap_unpack_mcename(
  uint8_t                                                           **ptr,
  LIBLTE_M2AP_MCE_NAME_STRUCT                                         *ie)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
 ...
 *******************************************************************************/
// lb:0, ub:512
LIBLTE_ERROR_ENUM liblte_m2ap_pack_repetitionperiod(
...
LIBLTE_ERROR_ENUM liblte_m2ap_unpack_repetitionperiod(
  uint8_t                                                          **ptr,
  LIBLTE_M2AP_REPETITION_PERIOD_STRUCT                              *ie)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
  ...
  uint8_t                                                **ptr)
{
     ...
     ptr != NULL)
  {
    ...
    if (ie->len > 32) {
      liblte_log_print(
        "Cell-Information-List pack error - max supported dynamic sequence length = 32, ie->len = %d\n",
        ie->len);
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
  ...
  uint8_t                                                           **ptr)
{
     ...
     ptr != NULL)
  {
    if(ie->len > 32) {
      liblte_log_print(
          "ProtocolIE_PMCH-Configuration-List pack error - max supported dynamic sequence length = 32, "
          "ie->len = %d\n",
          ie->len);
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
  ...
  uint8_t                                                           **ptr)
{
     ...
     ptr != NULL)
  {
    ...
    for(uint16_t i =0; i < ie->len; i++){
      ...
      tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
      if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                          LIBLTE_M2AP_IE_ID_PMCH_CONFIGURATION_ITEM,
                                          LIBLTE_M2AP_CRITICALITY_REJECT,
                                          ptr) != LIBLTE_SUCCESS) {
        return LIBLTE_ERROR_ENCODE_FAIL;
      }
  ...
  uint8_t                                                                   **ptr)
{
     ...
     ptr != NULL)
  {
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                        LIBLTE_M2AP_IE_ID_PMCH_CONFIGURATION_LIST,
                                        LIBLTE_M2AP_CRITICALITY_REJECT,
                                        ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
    ...
    *ptr += tmp_msg.N_bits;
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                        LIBLTE_M2AP_IE_ID_MBSFN_AREA_ID,
                                        LIBLTE_M2AP_CRITICALITY_REJECT,
                                        ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
     ...
     ptr != NULL)
  {
    ...
    for(i=0;i<n_ie;i++) {
      ...
      if(LIBLTE_M2AP_IE_ID_PMCH_CONFIGURATION_LIST == ie_id) {
        ...
        if(liblte_m2ap_unpack_mbsfnsubframeconfigurationlist(ptr, &ie->MBSFNSubframeConfigurationList) != LIBLTE_SUCCESS) {
          return LIBLTE_ERROR_DECODE_FAIL;
        }
        liblte_align_up(ptr, 8);
...
LIBLTE_ERROR_ENUM liblte_m2ap_pack_m2setuprequest(
  LIBLTE_M2AP_MESSAGE_M2SETUPREQUEST_STRUCT                          *msg,
  uint8_t                                                           **ptr)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
     ...
     ptr != NULL)
  {
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                          LIBLTE_M2AP_IE_ID_GLOBALENB_ID,
                                          LIBLTE_M2AP_CRITICALITY_REJECT,
                                          ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
...
LIBLTE_ERROR_ENUM liblte_m2ap_pack_m2setupresponse(
  LIBLTE_M2AP_MESSAGE_M2SETUPRESPONSE_STRUCT                          *msg,
  uint8_t                                                           **ptr)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
     ...
     ptr != NULL)
  {
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                          LIBLTE_M2AP_IE_ID_GLOBALMCE_ID,
                                          LIBLTE_M2AP_CRITICALITY_REJECT,
                                          ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
    ...
    *ptr += tmp_msg.N_bits;
    ...
    // ProtocolIE - MCCHrelatedBCCH-ConfigPerMBSFNArea
    tmp_ptr = tmp_msg.msg;
    if(liblte_m2ap_pack_mcchrelatedbcchconfigpermbsfnarea(&msg->MCCHrelatedBCCHConfigPerMBSFNArea, &tmp_ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
    liblte_align_up_zero(&tmp_ptr, 8);
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
     ...
     ptr != NULL)
  {
    ...
    for(i=0;i<n_ie;i++) {
      ...
      if(LIBLTE_M2AP_IE_ID_GLOBALMCE_ID == ie_id) {
        ...
        if(liblte_m2ap_unpack_mcchrelatedbcchconfigpermbsfnarea(ptr, &msg->MCCHrelatedBCCHConfigPerMBSFNArea) != LIBLTE_SUCCESS) {
          return LIBLTE_ERROR_DECODE_FAIL;
        }
        liblte_align_up(ptr, 8);
      }
  ...
  uint8_t                                                           **ptr)
{
     ...
     ptr != NULL)
  {
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                          LIBLTE_M2AP_IE_ID_MCE_MBMS_M2AP_ID,
                                          LIBLTE_M2AP_CRITICALITY_REJECT,
                                          ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
    ...
    *ptr += tmp_msg.N_bits;
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                          LIBLTE_M2AP_IE_ID_TNL_INFORMATION,
                                          LIBLTE_M2AP_CRITICALITY_REJECT,
                                          ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
  ...
  uint8_t                                                           **ptr)
{
     ...
     ptr != NULL)
  {
    ...
    *ptr += tmp_msg.N_bits;
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                          LIBLTE_M2AP_IE_ID_ENB_MBMS_M2AP_ID,
                                          LIBLTE_M2AP_CRITICALITY_REJECT,
                                          ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
...
LIBLTE_ERROR_ENUM liblte_m2ap_pack_mbmsschedulinginformation(
  LIBLTE_M2AP_MESSAGE_MBMSSCHEDULINGINFORMATION_STRUCT                          *msg,
  uint8_t                                                           **ptr)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
     ...
     ptr != NULL)
  {
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                          LIBLTE_M2AP_IE_ID_MCCH_UPDATE_TIME,
                                          LIBLTE_M2AP_CRITICALITY_REJECT,
                                          ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
    ...
    *ptr += tmp_msg.N_bits;
    ...
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
    if(liblte_m2ap_pack_protocolie_header(tmp_msg.N_bits / 8,
                                          LIBLTE_M2AP_IE_ID_MBSFN_AREA_CONFIGURATION_LIST,
                                          LIBLTE_M2AP_CRITICALITY_REJECT,
                                          ptr) != LIBLTE_SUCCESS) {
      return LIBLTE_ERROR_ENCODE_FAIL;
    }
 ...
 *******************************************************************************/
LIBLTE_ERROR_ENUM liblte_m2ap_pack_mbmsschedulinginformationresponse(
  ...
  uint8_t                                                           **ptr)
{
     ...
     ptr != NULL)
  {
    ...
    if(msg->CriticalityDiagnostics_present){
      ...
      tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
      if(liblte_m2ap_pack_protocolie_header((tmp_msg.N_bits) / 8,
                                            LIBLTE_M2AP_IE_ID_CRITICALITYDIAGNOSTICS,
                                            LIBLTE_M2AP_CRITICALITY_REJECT,
                                            ptr) != LIBLTE_SUCCESS) {
        return LIBLTE_ERROR_ENCODE_FAIL;
      }
...
LIBLTE_ERROR_ENUM liblte_m2ap_unpack_mbmsschedulinginformationresponse(
  uint8_t                                                           **ptr,
  LIBLTE_M2AP_MESSAGE_MBMSSCHEDULINGINFORMATIONRESPONSE_STRUCT                          *msg)
{
  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
  ...
  uint8_t                             **ptr)
{
     ...
     ptr                                      != NULL)
  {
    ...
    if(msg->choice_type == LIBLTE_M2AP_INITIATINGMESSAGE_CHOICE_M2SETUPREQUEST) {
      ...
      if(liblte_m2ap_pack_mbmsschedulinginformation(&msg->choice.MbmsSchedulingInformation, &tmp_ptr) != LIBLTE_SUCCESS) {
        return LIBLTE_ERROR_ENCODE_FAIL;
      }
    }
    tmp_msg.N_bits = tmp_ptr - tmp_msg.msg;
...
{  LIBLTE_ERROR_ENUM err = LIBLTE_ERROR_INVALID_INPUTS;
     ...
     ptr                                      != NULL)
  {
    ...
    if(msg->procedureCode == LIBLTE_M2AP_PROC_ID_M2SETUP) {
      ...
      if(liblte_m2ap_unpack_mbmsschedulinginformationresponse(ptr, &msg->choice.MbmsSchedulingInformationResponse) != LIBLTE_SUCCESS) {
        return LIBLTE_ERROR_DECODE_FAIL;
      }
      err = LIBLTE_SUCCESS;
    } else {
