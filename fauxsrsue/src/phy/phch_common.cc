...
void phch_common::init(phy_interface_rrc::phy_cfg_t *_config, phy_args_t *_args, srslte::log *_log, srslte::radio *_radio, rrc_interface_phy *_rrc, mac_interface_fauxphy *_mac)
{
  X_TRACE("PHCHCOMM:BEGIN");
  log_h     = _log; 
  radio_h   = _radio;
